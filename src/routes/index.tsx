    ...
    <>
      ...
      <section className="container-x mx-auto max-w-[1200px] mt-12 md:mt-16 relative z-20 px-4">
        ...
        >
          ...
          <div className="mt-5 flex justify-end">
            <button
              type="submit"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#827768] px-7 py-3 text-sm font-medium text-primary-foreground hover:scale-[1.02] transition-transform"
            >
      ...
      <section className="relative my-24 h-[70svh] min-h-[480px] w-full overflow-hidden">
        ...
        <div className="relative z-10 container-x mx-auto max-w-[1100px] h-full flex flex-col items-center justify-center text-center">
          ...
          <Link
            to="/plan-my-trip"
            className="mt-10 inline-flex items-center gap-2 rounded-full bg-[#827768] px-8 py-4 text-sm font-medium text-primary-foreground shadow-glow-lime hover:scale-105 transition-transform"
          >
