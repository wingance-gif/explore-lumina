    ...
    <>
      ...
      <section id="history" className="container-x mx-auto max-w-[1500px] grid lg:grid-cols-2 gap-12 pb-24 items-center scroll-mt-24">
        ...
        <div className="space-y-6 text-base md:text-lg text-foreground/80 leading-relaxed">
          ...
          <Link to="/contact" className="inline-flex items-center gap-2 rounded-full bg-gradient-accent px-7 py-4 text-sm font-medium text-primary-foreground shadow-glow-lime">
            Plan your trip →
          </Link>
        </div>
      </section>
      ...
      <section id="why" className="container-x mx-auto max-w-[1500px] pb-32 scroll-mt-24">
        ...
        <ScrollReveal className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {REASONS.map((v) => (
            <motion.div key={v.t} variants={fadeUp} className="glass rounded-2xl p-7">
      ...
      <section id="team" className="container-x mx-auto max-w-[1500px] pb-32 scroll-mt-24">
        ...
        >
          ...
          <Link to="/contact" className="mt-8 inline-flex items-center gap-2 rounded-full bg-gradient-accent px-7 py-4 text-sm font-medium text-primary-foreground shadow-glow-lime">
            Get in touch →
          </Link>
        </motion.div>
      </section>
