...
const FAQS: { q: string; a: string }[] = [
  ...
  { q: "How do I book a trip?", a: "Send us your dates, party size and interests via the Book Now form. We reply within 24 hours with a tailored proposal. A 30% deposit secures the booking; the balance is due 60 days before travel." },
