    ...
    <>
      ...
      <section className="container-x mx-auto max-w-[1500px] py-20 grid lg:grid-cols-3 gap-12">
        ...
        <aside className="lg:sticky lg:top-28 h-fit glass-strong rounded-3xl p-8">
          ...
          <Link to="/plan-my-trip" className="mt-8 w-full inline-flex items-center justify-center gap-2 rounded-full bg-[#827768] px-6 py-4 text-sm font-medium text-primary-foreground shadow-glow-lime hover:scale-[1.02] transition-transform">
