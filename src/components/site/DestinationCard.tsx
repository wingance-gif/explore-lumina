    ...
    <motion.article variants={fadeUp} className="group relative flex flex-col">
      ...
      >
        ...
        <div className="absolute inset-x-6 top-6 flex items-center justify-between">
          ...
          <span className="grid h-10 w-10 place-items-center rounded-full glass text-white transition-colors group-hover:bg-[#827768] group-hover:text-primary-foreground">
